...
--
-- Host: mysql-youpi.alwaysdata.net
...
CREATE TABLE `users` (
  ...
  `role` varchar(255) NOT NULL DEFAULT 'freelancer',
...
ALTER TABLE `orders`
  ...
  ADD KEY `orders_freelancer_id_foreign` (`freelancer_id`),
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_freelancer_id_foreign` FOREIGN KEY (`freelancer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
